...
.PHONY: build test lint gate clean audit deny govulncheck fmt clippy spec-check vectors fuzz bench rss release release-check quickstart triage
...
spec-check:
	...
	python3 scripts/conformance_cli.py
